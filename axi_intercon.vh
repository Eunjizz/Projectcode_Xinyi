...
wire        cnn_arlock;
wire  [3:0] cnn_arcache;
wire  [2:0] cnn_arprot;
wire  [3:0] cnn_arregion;
wire  [3:0] cnn_arqos;
wire        cnn_arvalid;
wire        cnn_arready;
wire  [3:0] cnn_rid;
...
axi_intercon axi_intercon
   (.clk_i          (clk),
    ...
    .i_cnn_arid     (cnn_arid),
   .i_cnn_araddr   (cnn_araddr),
   .i_cnn_arlen    (cnn_arlen),
   .i_cnn_arsize   (cnn_arsize),
   .i_cnn_arburst  (cnn_arburst),
   .i_cnn_arlock   (cnn_arlock),
   .i_cnn_arcache  (cnn_arcache),
   .i_cnn_arprot   (cnn_arprot),
   .i_cnn_arregion (cnn_arregion),
   .i_cnn_arqos    (cnn_arqos),
   .i_cnn_arvalid  (cnn_arvalid),
   .o_cnn_arready  (cnn_arready),
   .o_cnn_rid      (cnn_rid),
   .o_cnn_rdata    (cnn_rdata),
   .o_cnn_rresp    (cnn_rresp),
   .o_cnn_rlast    (cnn_rlast),
   .o_cnn_rvalid   (cnn_rvalid),
   .i_cnn_rready   (cnn_rready)
);
