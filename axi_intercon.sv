...
module axi_intercon
   (input  wire        clk_i,
    ...
    input wire  [2:0] i_cnn_arid,
    input wire [31:0] i_cnn_araddr,
    input wire  [7:0] i_cnn_arlen,
    input wire  [2:0] i_cnn_arsize,
    input wire  [1:0] i_cnn_arburst,
    input wire        i_cnn_arlock,
    input wire  [3:0] i_cnn_arcache,
    input wire  [2:0] i_cnn_arprot,
    input wire  [3:0] i_cnn_arregion,
    input wire  [3:0] i_cnn_arqos,
    input wire        i_cnn_arvalid,
    output  wire        o_cnn_arready,
    output  wire  [3:0] o_cnn_rid,
    output  wire [63:0] o_cnn_rdata,
    output  wire  [1:0] o_cnn_rresp,
    output  wire        o_cnn_rlast,
    output  wire        o_cnn_rvalid,
    input wire        i_cnn_rready
  ...
  localparam rule_t [1:0] AddrMap = '{
   ...
   //Master CNN
   assign masters_req[3].aw.id = 4'd0;
  assign masters_req[3].aw.addr = 32'd0;
  assign masters_req[3].aw.len = 8'd0;
  assign masters_req[3].aw.size = 3'd0;
  assign masters_req[3].aw.burst = 2'd0;
  assign masters_req[3].aw.lock = 1'd0;
  assign masters_req[3].aw.cache = 4'd0;
  assign masters_req[3].aw.prot = 3'd0;
  assign masters_req[3].aw.region = 4'd0;
  assign masters_req[3].aw.qos = 4'd0;
  assign masters_req[3].aw.atop = 6'd0;
  assign masters_req[3].aw_valid = 1'd0;
  assign masters_req[3].ar.id = {1'd0, i_cnn_arid};
  assign masters_req[3].ar.addr = i_cnn_araddr;
  assign masters_req[3].ar.len = i_cnn_arlen;
  assign masters_req[3].ar.size = i_cnn_arsize;
  assign masters_req[3].ar.burst = i_cnn_arburst;
  assign masters_req[3].ar.lock = i_cnn_arlock;
  assign masters_req[3].ar.cache = i_cnn_arcache;
  assign masters_req[3].ar.prot = i_cnn_arprot;
  assign masters_req[3].ar.region = i_cnn_arregion;
  assign masters_req[3].ar.qos = i_cnn_arqos;
  assign masters_req[3].ar_valid = i_cnn_arvalid;
  assign o_cnn_arready = masters_resp[3].ar_ready;
  assign masters_req[3].w.data = 64'd0;
  assign masters_req[3].w.strb = 8'd0;
  assign masters_req[3].w.last = 1'd0;
  assign masters_req[3].w_valid = 1'd0;
  assign masters_req[3].b_ready = 1'd0;
  assign o_cnn_rid = masters_resp[3].r.id[2:0];
  assign o_cnn_rdata = masters_resp[3].r.data;
  assign o_cnn_rresp = masters_resp[3].r.resp;
  assign o_cnn_rlast = masters_resp[3].r.last;
  assign o_cnn_rvalid = masters_resp[3].r_valid;
  assign masters_req[3].r_ready = i_cnn_rready;
